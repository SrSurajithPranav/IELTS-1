...
const STUDENT_NAV = [
  ...
  { id: 'plans',       icon: 'P', label: 'Plans',         group: 'learn' },
  { id: 'speaking',    icon: 'S', label: 'Speaking',      group: 'learn' },
  { id: 'writing',     icon: '✍️', label: 'Writing',       group: 'learn' },
  { id: 'vocabulary',  icon: 'V', label: 'Vocabulary',    group: 'learn' },
  { id: 'debate',      icon: 'D', label: 'Debate Mode',   group: 'learn' },
  { id: 'mocktest',    icon: '⏱',  label: 'Mock Test',     group: 'practice' },
  { id: 'games',       icon: 'G', label: 'Games Arena',   group: 'practice' },
  { id: 'quizzes',     icon: '❓', label: 'Quizzes',       group: 'practice' },
  { id: 'leaderboard', icon: 'L', label: 'Leaderboard',   group: 'social' },
  { id: 'liveclass',   icon: 'C', label: 'Live Sessions', group: 'social' },
  { id: 'resources',   icon: 'R', label: 'Resources',     group: 'social' },
];

const ADMIN_NAV = [
  { id: 'admin-home',      icon: '⊞',  label: 'Overview',     group: 'main' },
  { id: 'admin-students',  icon: 'S', label: 'Students',     group: 'main' },
  { id: 'admin-review',    icon: 'R', label: 'Review',       group: 'main' },
  { id: 'admin-audits',    icon: 'A', label: 'Audits',       group: 'main' },
  { id: 'admin-plans',     icon: 'P', label: 'Plans',        group: 'manage' },
  { id: 'admin-tasks',     icon: '✓',  label: 'Tasks',        group: 'manage' },
  { id: 'admin-sessions',  icon: 'C', label: 'Sessions',     group: 'manage' },
  { id: 'admin-resources', icon: 'R', label: 'Resources',    group: 'manage' },
  { id: 'admin-job-tokens',icon: 'J', label: 'Job Tokens',   group: 'manage' },
  { id: 'admin-quizzes',   icon: 'Q', label: 'Quiz Builder', group: 'manage' },
];
        ...
        <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)' }}>
          ...
          {user?.role === 'student' && user.streak > 0 && (
            <div style={{
              ...
              <span style={{ fontSize: 11, fontWeight: 800 }}>STREAK</span>
        ...
        <div style={{ padding: '8px 10px', borderTop: '1px solid var(--border)' }}>
          ...
          <a href={quickMeetUrl} target="_blank" rel="noopener noreferrer"
            ...
            <motion.div whileHover={{ x: 3 }} style={{
              ...
              <span style={{ fontSize: 11, fontWeight: 800 }}>LIVE</span> Quick Meet
            </motion.div>
          </a>
