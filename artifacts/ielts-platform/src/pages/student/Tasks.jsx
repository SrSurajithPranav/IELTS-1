...
const ICON_MAP = { speaking: 'S', writing: 'W', listening: 'L', reading: 'R', grammar: 'G' };
const COLOR_MAP = {
      ...
      <div className="fade-up-3">
        {loading ? (
          ...
          <Card style={{ textAlign: 'center', padding: 40 }}>
            <div style={{ fontSize: 18, fontWeight: 800, marginBottom: 12, color: 'var(--accent)' }}>TASKS</div>
