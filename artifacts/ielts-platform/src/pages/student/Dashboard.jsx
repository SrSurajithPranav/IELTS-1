...
export default function StudentDashboard() {
  ...
  const stats = [
    { label: 'Current Day',   value: `Day ${currentDay}`, icon: 'D', color: 'var(--accent)' },
    { label: 'Est. Score',    value: user?.score || 0,    icon: 'S', color: 'var(--gold)' },
    { label: 'Streak',        value: `${user?.streak || 0} days`, icon: '', color: 'var(--warn)' },
    { label: 'Tasks Reviewed',value: reviewed,            icon: 'R', color: 'var(--success)' },
  ];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <Card className="fade-up-3" style={{ padding: '20px 22px' }}>
        ...
        {pct === 100 && total > 0 && (
          ...
          >
            <span style={{ fontSize: 12, fontWeight: 800, color: 'var(--gold)' }}>DONE</span>
            <div>
