...
def speech_to_text(audio_url: str) -> dict:
    ...
    return {
        ...
        "confidence": None,
        "available": False,
        'note': 'Use Web Speech API on the client for real-time transcription, or configure a server STT provider.'
    }
...
def check_grammar(text: str) -> dict:
    ...
    return {
        ...
        "provider": "languagetool" if language_tool_available else "local-language-indicators",
        "provider_available": language_tool_available,
        "score_type": "language-indicator",
    }
